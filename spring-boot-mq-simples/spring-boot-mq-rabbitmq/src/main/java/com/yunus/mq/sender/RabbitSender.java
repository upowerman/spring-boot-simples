package com.yunus.mq.sender;

import com.alibaba.fastjson.JSON;
import com.yunus.config.SystemConfig;
import com.yunus.mq.CustomCorrelationData;
...
public class RabbitSender implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback, InitializingBean {
    ...
    public void confirm(CorrelationData correlationData, boolean ack, String cause) {
        // 消息回调确认失败处理
        if (!ack && correlationData instanceof CustomCorrelationData) {
     ...
     */
    private void convertAndSend(String exchange, String routingKey, final Object message, CustomCorrelationData correlationData) throws AmqpException {
        try {
